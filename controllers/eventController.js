...
const getAllEvents = async (req, res) => {
  try {
    ...
    queryParams.forEach(param => countRequest.input(param.name, param.type, param.value));
    const countResult = await countRequest.query(`SELECT COUNT(*) AS TotalCount FROM Events e WHERE 1=1`);
